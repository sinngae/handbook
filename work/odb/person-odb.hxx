...
namespace odb
{
  ...
  //
  template <>
  struct class_traits< ::personal >
  {
    static const class_kind kind = class_object;
  };

  template <>
  class access::object_traits< ::personal >
  {
    public:
    typedef ::personal object_type;
    typedef ::personal* pointer_type;
    typedef odb::pointer_traits<pointer_type> pointer_traits;
...
namespace odb
{
  ...
  //
  template <typename A>
  struct query_columns< ::personal, id_mysql, A >
  {
    // id
    //
    typedef
  ...
  template <typename A>
  const typename query_columns< ::personal, id_mysql, A >::id_type_
  query_columns< ::personal, id_mysql, A >::
  id (A::table_name, "`id`", 0);

  template <typename A>
  const typename query_columns< ::personal, id_mysql, A >::first_type_
  query_columns< ::personal, id_mysql, A >::
  first (A::table_name, "`first`", 0);

  template <typename A>
  const typename query_columns< ::personal, id_mysql, A >::last_type_
  query_columns< ::personal, id_mysql, A >::
  last (A::table_name, "`last`", 0);

  template <typename A>
  const typename query_columns< ::personal, id_mysql, A >::age_type_
  query_columns< ::personal, id_mysql, A >::
  age (A::table_name, "`age`", 0);

  template <typename A>
  struct pointer_query_columns< ::personal, id_mysql, A >:
    query_columns< ::personal, id_mysql, A >
  {
  };

  template <>
  class access::object_traits_impl< ::personal, id_mysql >:
    public access::object_traits< ::personal >
  {
    public:
    struct id_image_type
    {
  ...
  template <>
  class access::object_traits_impl< ::personal, id_common >:
    public access::object_traits_impl< ::personal, id_mysql >
  {
  };
