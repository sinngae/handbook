...
namespace odb
{
  ...
  struct access::object_traits_impl< ::personal, id_mysql >::extra_statement_cache_type
  {
    extra_statement_cache_type (
      mysql::connection&,
      image_type&,
  ...
  access::object_traits_impl< ::personal, id_mysql >::id_type
  access::object_traits_impl< ::personal, id_mysql >::
  id (const id_image_type& i)
  {
    mysql::database* db (0);
    ODB_POTENTIALLY_UNUSED (db);
  ...
  bool access::object_traits_impl< ::personal, id_mysql >::
  grow (image_type& i,
        my_bool* t)
  {
    ODB_POTENTIALLY_UNUSED (i);
  ...
  void access::object_traits_impl< ::personal, id_mysql >::
  bind (MYSQL_BIND* b,
        image_type& i,
        mysql::statement_kind sk)
  {
  ...
  const char access::object_traits_impl< ::personal, id_mysql >::persist_statement[] =
  ...
  const char access::object_traits_impl< ::personal, id_mysql >::find_statement[] =
  "SELECT "
  "`personal`.`id`, "
  "`personal`.`first`, "
  "`personal`.`last`, "
  ...
  const char access::object_traits_impl< ::personal, id_mysql >::update_statement[] =
  "UPDATE `personal` "
  "SET "
  "`first`=?, "
  "`last`=?, "
  ...
  const char access::object_traits_impl< ::personal, id_mysql >::erase_statement[] =
  "DELETE FROM `personal` "
  "WHERE `id`=?";

  const char access::object_traits_impl< ::personal, id_mysql >::query_statement[] =
  "SELECT "
  "`personal`.`id`, "
  "`personal`.`first`, "
  "`personal`.`last`, "
  ...
  const char access::object_traits_impl< ::personal, id_mysql >::erase_query_statement[] =
  "DELETE FROM `personal`";

  const char access::object_traits_impl< ::personal, id_mysql >::table_name[] =
  "`personal`";
  ...
  access::object_traits_impl< ::personal, id_mysql >::pointer_type
  access::object_traits_impl< ::personal, id_mysql >::
  find (database& db, const id_type& id)
  {
    using namespace mysql;
  ...
  result< access::object_traits_impl< ::personal, id_mysql >::object_type >
  access::object_traits_impl< ::personal, id_mysql >::
  query (database&, const query_base_type& q)
  {
    using namespace mysql;
  ...
  unsigned long long access::object_traits_impl< ::personal, id_mysql >::
  erase_query (database&, const query_base_type& q)
  {
    using namespace mysql;
